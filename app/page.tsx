        ...
        {particles.map((particle) => (
          <div
            ...
            style={{
              ...
              filter:
                particle.type === "mega-blur" ? "blur(8px)" : particle.type === "glow" ? "blur(4px)" : "blur(2px)",
              borderRadius: "50%",
            }}
          />
        ))}
...
export default function LostyoLanding() {
  ...
  // Função para buscar estatísticas do bot
  const fetchBotStats = useCallback(async () => {
    try {
      ...
      if (response.ok) {
        ...
        setStats({
          users: data.users || 150000,
          servers: data.servers || 5000,
          votes: data.votes || 25000,
        })
      } else {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-black to-gray-900 text-white overflow-hidden relative">
      ...
      <section className="relative z-20 px-4 sm:px-6 lg:px-8 pt-20 pb-16 sm:pt-32 sm:pb-24">
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-8 sm:mb-12">
            ...
            <div className="w-32 h-2 bg-gradient-to-r from-[#5865f2] via-[#8b9cff] to-[#a78bfa] mx-auto rounded-full blur-sm shadow-2xl shadow-[#5865f2]/50" />
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16 sm:mb-20">
            ...
            >
              <a
                ...
                className="flex items-center"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-gray-600/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-sm" />
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-10">
            {[
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 blur-xl" />
      ...
      <section className="relative z-20 px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 sm:mb-20">
            ...
            <div className="w-40 h-2 bg-gradient-to-r from-[#5865f2] via-[#8b9cff] to-[#a78bfa] mx-auto rounded-full blur-sm shadow-2xl shadow-[#5865f2]/60" />
      ...
      <section className="relative z-20 px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#5865f2]/20 via-[#8b9cff]/30 to-[#a78bfa]/20 blur-3xl rounded-full transform scale-150 opacity-60" />

          <div className="relative z-10 text-center">
            {/* Floating elements */}
            <div className="absolute -top-10 left-1/4 w-20 h-20 bg-gradient-to-br from-[#5865f2]/30 to-transparent rounded-full blur-xl animate-pulse" />
            <div className="absolute -top-5 right-1/3 w-16 h-16 bg-gradient-to-br from-[#a78bfa]/40 to-transparent rounded-full blur-lg animate-pulse delay-1000" />
            <div className="absolute top-10 left-1/6 w-12 h-12 bg-gradient-to-br from-[#f472b6]/30 to-transparent rounded-full blur-md animate-pulse delay-2000" />
            ...
            <div className="bg-gradient-to-br from-black/40 via-gray-900/30 to-black/40 backdrop-blur-3xl rounded-[3rem] p-12 sm:p-16 lg:p-20 shadow-2xl shadow-[#5865f2]/30 hover:shadow-[#5865f2]/50 transition-all duration-700 hover:scale-105 relative overflow-hidden">
              ...
              <div className="absolute inset-0 opacity-10">
                <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-[#5865f2]/20 via-transparent to-[#8b9cff]/20 animate-pulse" />
                <div className="absolute top-1/4 right-0 w-3/4 h-3/4 bg-gradient-to-bl from-white/10 to-transparent rounded-full blur-2xl" />
              </div>
              ...
              <div className="relative z-10">
                ...
                <div className="flex justify-center items-center mb-8 space-x-4">
                  <div className="w-3 h-3 bg-[#5865f2] rounded-full animate-ping" />
                  <div className="w-4 h-4 bg-[#8b9cff] rounded-full animate-pulse" />
                  <Star className="w-16 h-16 text-[#5865f2] animate-pulse drop-shadow-2xl filter drop-shadow-[0_0_30px_currentColor]" />
                  <div className="w-4 h-4 bg-[#a78bfa] rounded-full animate-pulse delay-500" />
                  <div className="w-3 h-3 bg-[#f472b6] rounded-full animate-ping delay-1000" />
                </div>
                ...
                <div className="flex justify-center mb-8">
                  <div className="w-32 h-1 bg-gradient-to-r from-transparent via-[#5865f2] to-transparent rounded-full blur-sm" />
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                  ...
                  >
                    <a
                      ...
                      className="flex items-center"
                    >
                      <div className="absolute inset-0 bg-gradient-to-r from-white/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 blur-xl" />
                  ...
                  >
                    <a
                      ...
                      className="flex items-center"
                    >
                      <div className="absolute inset-0 bg-gradient-to-r from-[#5865f2]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 blur-xl" />
                ...
                <div className="mt-12 flex flex-col sm:flex-row justify-center items-center gap-8 text-center">
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-red-400 rounded-full animate-pulse delay-1000" />
      ...
      <footer className="relative z-20 px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-[#5865f2] via-[#8b9cff] to-[#a78bfa] mx-auto rounded-full blur-sm shadow-xl shadow-[#5865f2]/40" />
          </div>
